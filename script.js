...
//Function determineLength used to determine the length of the password and adds parameters to allow only passwords from 8-128 characters long
...
//Function used to determine whether the user wants to include uppercase characters in the password, if/else if statements split to predict empty answers, single char 'y' or 'n'
